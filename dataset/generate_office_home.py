...
dir_path = "./Dataset/"
# 처리할 도메인 디렉토리 리스트
domain_names = ['Art/', 'Clipart/', 'Real World/']
num_classes = 65

def generate_office_home_mixed(dir_path, num_clients, num_classes, niid, balance, partition):
    # 기본 디렉토리 및 서브디렉토리 생성
...
if __name__ == "__main__":
    # 예: 클라이언트 수 10로 설정
    generate_office_home_mixed(dir_path, num_clients=10, num_classes=num_classes, niid=True, balance=False, partition="dir")
